...
function reducer(state, action) {
    switch (action.type) {
        ...
        default: throw new Error("unkwnown action type")
    }
}

function CitiesProvider({ children }) {
    const [{ cities, isLoading, currentCity, error }, dispatch] = useReducer(reducer, inititalState)
...
function UseCities() {
    ...
    if (context === undefined) throw new Error("context used outside Cities Provider")
